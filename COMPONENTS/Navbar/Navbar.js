        ...
        <nav>
            <div className='s1'>
                ...
                <div className='searchbar'>
                    <input typ="text" placeholder="Search Terrier,Kitten,etc" className='search' />
            ...
            <div className='s2'>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item href="#/action-1">Dogs</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">Cats</Dropdown.Item>
                        ...
                        <ul className='s32'>
                            ...
                            <li><Dropdown>
                                ...
                                <Dropdown.Menu>
                                    ...
                                    <Dropdown.Item href="#/action-2">Cats</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3">Birds</Dropdown.Item>
